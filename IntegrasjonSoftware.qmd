...
### Stata og SPSS 
Det er mange forskjellige statistikksoftware i bruk, og i samfunnsvitenskap har Stata vært dominerende inntil nylig. Før det var SPSS det dominerende. Nå tar R over, men en gang fremtiden er det kanskje noe helt annet. Uansett vil du lett havne i en situasjon der du trenger å forholde deg til Stata og kanskje også SPSS eller andre software. Et vanlig case er at du skal samarbeide med noen. En annen mulighet er at du skal ta et videregående metodekurs der de bruker f.eks. Stata. 

Dette er ikke stedet å diskutere ulike software sine styrker og svakheter. Hvis du vil se lange diskusjoner om hvilken software som er best, så er det nok av diskusjonsgrupper på nettet der dette er temaet. Det er riktignok bortkastet tid fordi folk har ulike behov og verdsetter ulike ting. Grunnen til at du skal forholde deg til annen software er først og fremst at andre folk bruker dem.
